                ...
                <Col lg={6}>
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control type="text" placeholder="Enter Difficulty" name="quantity" onChange={handleChange} />
                        </Form.Group>

                        <Form.Group className="mb-3">
                            <Form.Label>Duration_weeks</Form.Label>
                            <Form.Control type="number" placeholder="Enter Duration" name="quantity" onChange={handleChange} />
                        </Form.Group>
